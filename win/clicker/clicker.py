...
def mouse_click():
    ...
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN,val[0],val[1],0,0)
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP,val[0],val[1],0,0)
